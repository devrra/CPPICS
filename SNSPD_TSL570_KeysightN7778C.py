...
if n7778c_state==2 and tsl570_state==0:
    ...
    filename = "n7778c_power_{}dBm_sweep_{}_{}_{}_tsl570_off_{}".format(n7778c_power,n7778c_sweep[0],n7778c_sweep[-1],wavl_step,suffix)
    ...
    filename = "n7778c_off_tsl570_power_{}dBm_sweep_{}_{}_{}_{}".format(tsl570_power,tsl570_sweep[0],tsl570_sweep[-1],wavl_step,suffix)
    filename = "".join(['p' if char == '.' else char for char in filename])
    ...
    for i in range(len(n7778c_sweep)):
        ...
        time.sleep(0.1)
        print('n7778c: {}, {}'.format(n7778c_sweep[i], counts[i]))
    filename = "n7778c_power_{}dBm_sweep_{}_{}_{}_tsl570_power_{}dBm_wavelength_{}_{}".format(n7778c_power,n7778c_sweep[0],n7778c_sweep[-1],wavl_step,tsl570_power,tsl570_sweep[-1],suffix)
    filename = "".join(['p' if char == '.' else char for char in filename])
    plot_n_save(n7778c_sweep,counts,filename)
    ...
    for i in range(len(tsl570_sweep)):
        ...
        time.sleep(0.1)
        print('tsl570: {}, {}'.format(tsl570_sweep[i], counts[i]))
    filename = "n7778c_power_{}dBm_wavelength_{}_tsl570_power_{}dBm_sweep_{}_{}_{}_{}".format(n7778c_power,n7778c_sweep[-1],tsl570_power,tsl570_sweep[0], tsl570_sweep[-1], wavl_step, suffix)
    filename = "".join(['p' if char == '.' else char for char in filename])
    plot_n_save(tsl570_sweep,counts,filename)
